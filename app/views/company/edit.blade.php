				...
				@if( isset($company) )
					<form action="{{ route('company.update', $company->id) }}" method="POST">
						...
						<div class="form-group {{ $errors->has('name') ? ' has-error' : ''}}">
						    ...
						    <input type="text" class="form-control" name="name" placeholder="XYZ Corporation" value="{{ Request::old('name') ?: $company->name }}">
						    @if( $errors->has('name') )
						...
						<div class="form-group {{ $errors->has('address') ? ' has-error' : ''}}">
							...
							<input type="text" class="form-control" name="address" placeholder="123 Main St." value="{{ Request::old('address') ?: $company->address }}">
						...
						<div class="form-group {{ $errors->has('city') ? ' has-error' : ''}}">
							...
							<input type="text" class="form-control" name="city" placeholder="Panama City" value="{{ Request::old('city') ?: $company->city }}">
							@if( $errors->has('city') )
						...
						<div class="form-group {{ $errors->has('zip') ? ' has-error' : ''}}">
							...
							<input type="text" class="form-control" name="zip" placeholder="32401" value="{{ Request::old('zip') ?: $company->zip }}">
							@if( $errors->has('zip') )
						...
						<div class="form-group {{ $errors->has('phone') ? ' has-error' : ''}}">
							...
							<input type="text" class="form-control" name="phone" placeholder="(850) 867-5309" value="{{ Request::old('phone') ?: $company->phone }}">
							@if( $errors->has('phone') )
